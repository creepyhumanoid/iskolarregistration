		...
		<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<tbody>
				<?php
		            ...
		            $pets = "SELECT * FROM tbliskolars WHERE `status_id`=1";
		            ...
		            while ($con=mysqli_fetch_assoc($petsquery)) {
						...
						echo "<td>".$course."</td>";
						echo "<td>".$status."</td>";
						echo "<td>"."<button type='button' class='btn btn-info' data-target='#edit-".$con['ID']."' data-toggle='modal'><span class='fa fa-pencil' aria-hidden='true'></span></button><button type='button' class='btn btn-success' data-target='#restore-".$con['ID']."' data-toggle='modal'>RESTORE</button>"."</td>";
						echo "</tr>";
				?>
  				...
  				<div class="modal-dialog">
    				<div class="modal-content">
      					...
      					<div class="modal-body" style="margin-top: 5%;">
         					<form role="form" id="contact-form" method="POST" action="iskolarrestore.php">
